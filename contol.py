...
def solve(instance_name):
    ...
    if os.path.isfile(executable_path) and os.access(executable_path, os.X_OK):
        ...
        result = subprocess.run([f"./{executable_name}", "FirstInstances/test.qlp"], cwd=yasol_directory, capture_output=True, text=True)
...
if __name__ == "__main__":
    for  filename in os.listdir(os.path.join(yasol_directory, "FirstInstances")):
        solve(filename)
